    ...
    try {
      switch (targetType) {
        ...
        case 'AuthorizationValue':
          return dson.map(value, new AuthorizationValue());
        case 'CliOption':
          return dson.map(value, new CliOption());
        case 'GeneratorInput':
          return dson.map(value, new GeneratorInput());
        case 'ResponseCode':
          return dson.map(value, new ResponseCode());
        case 'SecuritySchemeDefinition':
          return dson.map(value, new SecuritySchemeDefinition());
        default:
          {
            Match match;
            if (value is List &&
